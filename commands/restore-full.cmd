...
while [[ $# -gt 0 ]]; do
    case "$1" in
        --help|-h)
            ## Do NOT re-invoke `roll restore-full --help` here. `restore-full` is on roll's ROLL_CMD_ANYARGS
            ...
            ## usage.cmd renders ROLL_CMD_HELP (restore-full.help) and exits on its own.
